    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['app:carousel:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['app:carousel:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listCarousel, getCarousel, delCarousel, addCarousel, updateCarousel, exportCarousel } from "@/api/app/carousel";
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        pageNum: 1,
        pageSize: 10,
        img: undefined,        title: undefined,        type: undefined,        url: undefined,        status: undefined     },
      // 表单参数
      form: {},
      // 表单校验
      rules: {
  ...
  methods: {
    ...
    reset() {
      this.form = {
        id: undefined,        img: undefined,        title: undefined,        type: undefined,        url: undefined,        status: undefined    };
      this.resetForm("form");
    },
    /** 搜索按钮操作 */
    handleQuery() {
    ...
    handleExport() {
        ...
        this.$confirm('是否确认导出所有轮播内容设置数据项?', "警告", {
