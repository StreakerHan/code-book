<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="feedbackList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="反馈内容" align="center" prop="context" />
      <el-table-column label="图片" align="center" prop="images" >
        <template slot-scope="scope">
          <img :src="scope.row.images" style="height:50px"/>
        </template>
        </el-table-column>
...
<script>
import { listFeedback, getFeedback, delFeedback, addFeedback, updateFeedback, exportFeedback } from "@/api/app/feedback";
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        pageNum: 1,
        pageSize: 10,
        context: undefined,        images: undefined,        mobile: undefined,        type: undefined,        userId: undefined      },
      // 表单参数
      form: {},
      // 表单校验
      rules: {
  ...
  methods: {
    ...
    reset() {
      this.form = {
        id: undefined,        createTime: undefined,        context: undefined,        images: undefined,        mobile: undefined,        type: undefined,        userId: undefined      };
      this.resetForm("form");
    },
    /** 搜索按钮操作 */
    handleQuery() {
