...
class UpdateUtil {
  ...
  static Future<Map> getUpgrade() async {
    if (Platform.isAndroid) {
      ...
      var result = await Dio().get("http://" +
          ApiPath.BASE_URL +
          "/app/appVersion/appVersion?type=BOOKANDROID");
      if (result.data != "") {
        String serverAndroidVersion = result.data["data"]["versionName"];
        String serverAndroidUrl = result.data["data"]["download_url"];
        String serverAndroidMsg = result.data["data"]["content"];
      ...
      var result = await Dio().get(
          "http://" + ApiPath.BASE_URL + "/app/appVersion/appVersion?type=BOOKIOS");
      print(result);
      if (result.data != "") {
        String serverAndroidVersion = result.data["data"]["versionName"];
        String serverAndroidUrl = result.data["data"]["download_url"];
